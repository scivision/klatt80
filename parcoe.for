...
135     WRITE (6,140) NTIMEP
140     FORMAT (' INPUT PARS AT T = ',I4,' MS')
        WRITE (6,141) (I(NPP),NPP=NPPBEG,NPPEND)
141     FORMAT (' ',13I5)
        WRITE (6,142)
142     FORMAT (' ')
145     NPAR=1
...
C     ADD A STEP TO WAVEFORM AT A PLOSIVE RELEASE
        PLSTEP=0.
        IF (NNAF-NAFLAS < 49) GO TO 151
        PLSTEP=GETAMP(NNG0+NDBSCA(11)+44_int16)
151     NAFLAS=NNAF
...
C     WAVEFORM MORE SINUSOIDAL AT HIGH FUNDAMENTAL FREQUENCY
        ...
        CALL SETABC(0_int16,NNBGS,AGS,BGS,CGS)
        MNFGZ=-NNFGZ
